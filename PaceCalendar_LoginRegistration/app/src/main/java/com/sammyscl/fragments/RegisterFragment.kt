...
class RegisterFragment : Fragment() {
    ...
    private var mEtSurname: EditText? = null
    ...
    private var mTiSurname: TextInputLayout? = null
    ...
    private fun initViews(v: View) {
        ...
        mEtSurname = v.findViewById<View>(R.id.et_surname) as EditText
        ...
        mTiSurname = v.findViewById<View>(R.id.ti_surname) as TextInputLayout
    ...
    private fun register() {
        ...
        val surname = mEtSurname!!.text.toString()
        ...
        if (!validateFields(surname)) {
            ...
            err++
            mTiName!!.error = "Surname should not be empty !"
        }
